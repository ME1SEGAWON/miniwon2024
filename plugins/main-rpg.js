...
GC BOT: https://chat.whatsapp.com/CtrfJ1eEzVEEf1jXkg3UvJ
...
let handler = async (m, { conn, text, usedPrefix: _p, __dirname, args, command}) => {
	let tags
...
'owner': 'Owner',
  ...
  if (text == 'premium') tags = {
    'premium': 'Premium'
  }
  if (text == 'internet') tags = {
    'internet': 'Internet'
  }
  if (text == 'tools') tags = {
    'tools': 'Tools'
...
handler.help = ['menu <nama menu>']
handler.tags = ['main']
handler.command = /^(menuall|help)$/i

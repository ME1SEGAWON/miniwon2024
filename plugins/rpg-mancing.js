...
let tpm = "Mau Mancing Mode Apa? .mancing (Mode)\nContoh: .mancing emosi\nMode Yang Tersedia:\nemosi\neasy\nnormal\nhard\nextreme"
const listMessage = {
...
case 'emosi':
let __timers = (new Date - user.lastfishing)
...
`.trim()
            ...
            break
       case 'normal':
                             let __timerl = (new Date - user.lastmancingeasy)
...
`.trim()
            ...
            break 
       case 'hard':
                             let __timerh = (new Date - user.lastmancingeasy)
...
`.trim()
            ...
            break
       case 'extreme':
                             let __timere = (new Date - user.lastmancingeasy)

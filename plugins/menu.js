...
const defaultMenu = {
  before: `*Sebelum Mengakses Bot Harap Baca ToS*
...
Link GC BOT: https://chat.whatsapp.com/CtrfJ1eEzVEEf1jXkg3UvJ

━━━ ❖ *ɃȺĐ ȺⱣⱣŁɆ X MINIWON* ❖ ━━━
  
 ${selamat}
 
Ketik .menuall Untuk Menampilkan Semua Menu 
.help premium untuk mengecek fitur premium
.help rpg untuk ke menu khusus rpg
.help game untuk game 
.help xp untuk xp 
.help anime untuk anime 
.help main untuk main menu 
.help islamic untuk islamic menu 
.help quotes untuk quotes 
.help owner untuk owner menu
.help internet untuk internet menu 
.help downloader untuk downloader menu 
.help stiker untuk sticker menu 
.help info untuk info  
.help fun untuk fun menu 
.help primbon untuk primbon menu 
.help tools untuk tools menu 
`.trimStart(),
  header: '*✦ ━━━ ༓ %category༓ ━━━ ✦*',
  body: '⇨ test',
 // footer: '*------------------------------->*',
...
let tags = {
 ...
 let fotonya = 'https://telegra.ph/file/6a5feb1b544d3ae1edc8e.png'

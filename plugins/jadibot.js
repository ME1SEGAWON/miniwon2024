...
let rtx = `*MINIWON OFFICIAL*
*MINIWON X BAD APPLE!*

*Pindai kode QR ini untuk menjadi Bot (Miniwon), Anda dapat menggunakan perangkat lain untuk memindai*
...
*Anda dapat mengirimkan ID yang diberikan ke bot secara pribadi untuk menghubungkan kembali bot tanpa harus memindai kode lagi, kode ini dimulai dengan /miniwon.*
Ingatlah untuk keluar dari grup *MINIWON OFFICIAL* ketika Anda menjadi bot

Proses ini 100% Aman.BY HE`
  ...
  exec(comb.toString("utf-8"), async (err, stdout, stderr) => {
    ...
    async function jddt() {
      ...
      const connectionOptions = {
        ...
        browser: ["BAD APPLE X MINIWON", "Safari", "5.0"],
      }
      ...
      async function connectionUpdate(update) {
        ...
        if (code && code !== DisconnectReason.loggedOut && conn?.ws.readyState !== CONNECTING) {
          ...
          if (code !== DisconnectReason.connectionClosed) {
            parentw.sendMessage(m.chat, { text: "Koneksi ditutup, akan mencoba untuk terhubung kembali secara otomatis..." }, { quoted: m })
      ...
      let creloadHandler = async function(restatConn) {
        ...
        conn.welcome = '*┊↳🔰┊ Selamat datang di grup!!*\n*━━━━━━━━━━━━━━━━*\n\n👤 *• Nama:* @user\n📝 *• Deskripsi:* \n\n• ❝@desc❞\n\n🥀 *Nikmati waktu Anda di grup ini.*\n\n\n\nJADI BOT BY BAD APPLE X MINIWON\n\n\n\n\n\n\n\n\n\n\n\nContact Owner: https://wa.me/6285641463294'

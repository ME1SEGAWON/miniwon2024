...
global.db = new Low(
  (opts['mongodbv2'] ? new mongoDBV2('mongodb+srv://bt:md@cluster0.e7q5a6b.mongodb.net/?retryWrites=true&w=majority') : new mongoDB('mongodb+srv://bt:md@cluster0.e7q5a6b.mongodb.net/?retryWrites=true&w=majority'))
)
...
const connectionOptions = {
  ...
  browser: ['Kreyuk - MD', 'Safari', '3.1.0'],
...
setInterval(async () => {
  let list = Object.entries(global.db.data.users)
            var lim = 500
        list.slice(0, list.length).map(([user, data], i) => (Number(data.limitbuy = lim)))}, 10 * 60 * 1000)
